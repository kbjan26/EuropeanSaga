        ...
        return {
            ...
            link: function (scope) {
                ...
                function configChanged() {
                    ...
                    console.log("Disqus short name ="+scope.config.disqus_shortname);
                    console.log("Disqus identifier ="+scope.config.disqus_identifier);
                    console.log("Disqus url ="+scope.config.disqus_url);
